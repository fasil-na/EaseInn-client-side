...
import "./FavouriteHotelCards.css";
...
function FavouriteHotelCards() {
  ...
  const favoriteHotels = hotels.filter((hotel) => favorites.includes(hotel._id));

  return (
    <div className="hotel-page-container">
      <h1 className="hotel-list-heading">Favourites</h1>
...
export default FavouriteHotelCards;
